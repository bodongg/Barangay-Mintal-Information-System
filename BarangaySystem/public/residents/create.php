...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (count($errors) === 0) {
    try {
      ...
      header('Location: /BarangaySystem/public/residents/index.php?msg=saved');
      exit;
    } catch (Throwable $e) {
      $errors[] = 'Failed to save resident. Check database connection.';
    }
  }
}
?>
    ...
    <div class="card">
      <div class="table-header">
        <div>
          ...
          <div class="card-sub">Create a resident record</div>
        </div>
